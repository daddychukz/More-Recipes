          ...
          <div className="container">
            <div className="row" id="parent">
              <div className="col-lg-8 d-none d-lg-block">
                <h1 className="display-4"> Share your <strong> awesome </strong>
                and exciting <strong>recipe</strong> ideas</h1>
                ...
                <div className="d-flex flex-row">
                  ...
                  <div className="p-4 align-self-end">
                  Discover recipes, cooks, and how-tos based on the food you
